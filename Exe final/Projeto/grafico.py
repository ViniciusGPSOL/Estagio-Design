...
#Dados do gráfico
        ...
        self.ax.legend(valores_x, loc='upper left', bbox_to_anchor=(-0.6, 0.25, 0.5, 0.5), ncol=1)
...
#Dados do gráfico
        ...
        for sec in x:
            ...
            for posicao in range(numero_parametros):
                ...
                self.ax.text(x[sec] + width, ypoints[sec][posicao], str(ypoints[sec][posicao]), fontsize=fonte)
                width += widthb
        ...
        self.ax.legend(parametros, loc='upper left', bbox_to_anchor=(1, 1), ncol=1)
...
#Dados do gráfico
        ...
        while rep != len(lista_valores):
            ...
            for i, v in enumerate(ypoints):
            	self.ax.text(i, v+15, "%d" %v, ha="center", fontsize=fonte)
            plt.ylim(-10, nmax + 100)

            print(lista_valores[rep])
            for tm in lista_valores[rep]:
	            if tm > nmax:
	            	nmax = tm
